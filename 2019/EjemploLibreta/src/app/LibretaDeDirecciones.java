...
public class LibretaDeDirecciones {
	...
	public DatosContacto getContactoV2(String clave) throws ClaveNoExisteExcecption,ClaveVaciaExcecption
	{
		if (clave.isEmpty()) throw new ClaveVaciaExcecption("la clave esta vacia");
