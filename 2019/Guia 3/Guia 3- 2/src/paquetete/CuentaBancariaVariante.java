...
public class CuentaBancariaVariante 
{
	private int identificador;
	private int balance;
	private Cliente cliente;
	private ArrayList <String> registroVariante;
	
	public CuentaBancariaVariante () {
		setIdentificador(0);
		setBalance(0);
		setCliente(null);
		registroVariante= new ArrayList <String>();
	}
	
	public CuentaBancariaVariante (int identificadorR, int balanceR, Cliente clienteR) {
