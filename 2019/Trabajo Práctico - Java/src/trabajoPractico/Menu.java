...
public class Menu
{
	public static void main(String[] args)
	{
		...
		System.out.println("\n>>> EJERCICIO 6 <<<\n"); //La guía del ejerc. 4 salta al ejerc. 6 (no hay ejer. 5)
		revisarSiEsPrimo();
	...
	{
		//Al trabajar con tantos datos ya están previamente ingresados (en vez de tener escanearlos por teclado)
