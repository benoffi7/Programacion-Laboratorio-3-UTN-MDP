...
import Clases.Ejercicio14;
import Clases.Ejercicio15;
import Clases.Ejercicio16;
import Clases.Ejercicio17;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Ejercicio 1
		 ...
		 int []a= new int [5]; double promedio;
		  
		  Ejercicio1 ejercicio1=new Ejercicio1(); ejercicio1.cargar_elementos(a);
		  promedio=ejercicio1.sacar_promedio_array(a); ejercicio1.mostrar_array(a);
		  System.out.println("El promedio es : " +promedio);
		  
		 
		 //Ejercicio 2
		
		  Boolean i; int a=10; Ejercicio2 ejercicio2= new Ejercicio2();
		  i=ejercicio2.sacar_par(a);
		  
		  if(i == true) { System.out.println("Es par"); } else {
		...
		// Ejercicio 6
		  ...
		  Ejercicio6 ejercicio6 = new Ejercicio6(); Boolean flag; String control =
		  "si";
		  
		  while (control.equalsIgnoreCase("si")) {
		  System.out.println("Ingrese el numero para verificar si es primo"); int
		  numero = scanf.nextInt(); flag = ejercicio6.esPrimo(numero); if (flag ==
		  true) { System.out.println("El numero es primo"); } else {
		  System.out.println("El numero no es primo"); }
		  
		  System.out.println("Desea seguir cargando otro numero?"); control =
		  scanf.next();
		...
		while (control.equalsIgnoreCase("si")) {
			...
			flag = ejercicio8.esPositivo(numero);
		...
		System.out.println("La cantidad de numeros positivos ingresados fueron: " + i);
		...
		System.out.println("Ingrese el año a comprobar si es bisiesto");
		anio = scanf.nextInt();
		flag = ejercicio9.esBisiestos(anio);
		...
		if(edad<18)
		{
			...
			System.out.println("Sos menor amigo,ingresa bien tu edad :) ");
